...
export var hljs = (function () {
  ...
  var Ke = Object.freeze({
    ...
    grmr_xml: (e) => {
      const regexPart1 = '[\\p{L}_]';
      const regexPart2 = '[\\p{L}0-9_.-]*:';
      const regexPart3 = '[\\p{L}0-9_.-]*';
      const n = e.regex,
      t = new RegExp(n.concat(
        regexPart1,
        n.optional(regexPart2),
        regexPart3
      ), 'u'),
        a = {
          className: "symbol",
        ...
        l = {
          ...
          relevance: 0,
          contains: [
            { className: "attr", begin: new RegExp('[\\p{L}0-9._:-]+', 'u'), relevance: 0 },
            {
              begin: /=\s*/,
              relevance: 0,
              contains: [
