...
const markdown = function () {
  ...
  function s(e, r, t) {
    var o,
      ...
      u = ''
    for (
      typeof r !== 'string' && ((t = r), (r = s.defaultChars)),
        void 0 === t && (t = !0),
        l = (function (e) {
          var r,
            t,
 ...
 if (
      ...
      ) { (u += e.slice(o, o + 3)), (o += 2) } else if (a < 128) u += l[a]
  ...
  function a(e, r) {
    var t
    return (
      typeof r !== 'string' && (r = a.defaultChars),
      (t = (function (e) {
        var r,
          t,
          n = i[e]
 ...
 (s = parseInt(e.slice(r + 1, r + 3), 16)) < 128
            ...
            : (224 & s) == 192 &&
              r + 3 < n &&
              (192 & (o = parseInt(e.slice(r + 4, r + 6), 16))) == 128
            ? ((l +=
                (c = ((s << 6) & 1984) | (63 & o)) < 128
                  ? '\ufffd\ufffd'
  ...
  (l.prototype.parse = function (e, r) {
    ...
    if (
      ...
      var p,
        f,
        d = -1
      for (t = 0; t < g.length; t++) { (o = a.indexOf(g[t])) !== -1 && (d === -1 || o < d) && (d = o) }
      for (
        (f = d === -1 ? a.lastIndexOf('@') : a.lastIndexOf('@', d)) !== -1 &&
          ((p = a.slice(0, f)), (a = a.slice(f + 1)), (this.auth = p)),
          d = -1,
          t = 0;
        t < m.length;
        t++
      ) { (o = a.indexOf(m[t])) !== -1 && (d === -1 || o < d) && (d = o) }
      d === -1 && (d = a.length), a[d - 1] === ':' && d--
      var y = a.slice(0, d);
      (a = a.slice(d)),
        this.parseHost(y),
    ...
    var z = a.indexOf('?')
    return (
      z !== -1 && ((this.search = a.substr(z)), (a = a.slice(0, z))),
      a && (this.pathname = a),
  ...
  var y = {
    ...
    S = function (e, r, t) {
      ...
      if (e.charCodeAt(o) === 60) {
        for (o++; o < t;) {
          if ((n = e.charCodeAt(o)) === 10) return i
          if (n === 60) return i
          if (n === 62) {
 return (
              (i.pos = o + 1), (i.str = E(e.slice(r + 1, o))), (i.ok = !0), i
            )
}
          n === 92 && o + 1 < t ? (o += 2) : o++
        }
      ...
      for (
        s = 0;
        o < t && (n = e.charCodeAt(o)) !== 32 && !(n < 32 || n === 127);

      ) {
 if (n === 92 && o + 1 < t) {
          if (e.charCodeAt(o + 1) === 32) break
          o += 2
        } else {
          if (n === 40 && ++s > 32) return i
          if (n === 41) {
            if (s === 0) break
            s--
          }
      ...
      return (
        r === o ||
          s !== 0 ||
          ((i.str = E(e.slice(r, o))), (i.pos = o), (i.ok = !0)),
        i
      )
    },
    F = function (e, r, t) {
      ...
      if (i >= t) return a
      if ((s = e.charCodeAt(i)) !== 34 && s !== 39 && s !== 40) return a
      for (i++, s === 40 && (s = 41); i < t;) {
        if ((n = e.charCodeAt(i)) === s) {
 return (
            (a.pos = i + 1),
            (a.lines = o),
            (a.str = q(e.slice(r + 1, i))),
            (a.ok = !0),
            a
          )
}
        if (n === 40 && s === 41) return a
        n === 10
          ? o++
    ...
    L = {
      parseLinkLabel: function (e, r, t) {
        ...
        for (e.pos = r + 1, n = 1; e.pos < c;) {
          if ((o = e.src.charCodeAt(e.pos)) === 93 && --n === 0) {
            s = !0
            break
          }
 ...
 (o = e[n].type) === 'inline'
  ...
  (N.prototype.__find__ = function (e) {
    ...
    (N.prototype.getRules = function (e) {
      return (
        this.__cache__ === null && this.__compile__(), this.__cache__[e] || []
      )
    })
  var O = N,
    P = /\r\n?|\n/g,
 ...
 (t = e[r]).type !== 'text' || n || (t.content = t.content.replace(G, J)),
      ...
      if (((v.length = k + 1), n.type === 'text')) {
        ...
        e: for (; i < a && ((re.lastIndex = i), (o = re.exec(s)));) {
          if (
            ...
            (u = 32),
            o.index - 1 >= 0)
          ) { u = s.charCodeAt(o.index - 1) } else {
 for (
              k = t - 1;
              k >= 0 && e[k].type !== 'softbreak' && e[k].type !== 'hardbreak';
              k--
            ) {
 if (e[k].content) {
 ...
 if (l.single === b && v[k].level === c) {
                  (l = v[k]),
                    b
                      ? ((y = r.md.options.quotes[2]),
                        (C = r.md.options.quotes[3]))
                      : ((y = r.md.options.quotes[0]),
                        (C = r.md.options.quotes[1])),
                    (n.content = te(n.content, o.index, C)),
                    (e[l.token].content = te(e[l.token].content, l.pos, y)),
                    (i += C.length - 1),
                    l.token === t && (i += y.length - 1),
 ...
 if (b[t].type === 'inline' && e.md.linkify.pretest(b[t].content)) {
 for (f = 0, r = (s = b[t].children).length - 1; r >= 0; r--) {
 if ((i = s[r]).type !== 'link_close') {
                    if (
                      (i.type === 'html_inline' &&
                        ((k = i.content),
                        /^<a[>\s]/i.test(k) && f > 0 && f--,
 ...
 (d = _[c].url),
                          ...
                          e.md.validateLink(m) &&
                            ((g = _[c].text),
                            (g = _[c].schema
                              ? _[c].schema !== 'mailto:' || /^mailto:/i.test(g)
 ...
 for (
                      r--;
                      s[r].level !== i.level && s[r].type !== 'link_open';
 ...
 if (a[r].type === 'inline') {
              for (o = (n = a[r].children).length, s = 0; s < o; s++) { n[s].type === 'text_special' && (n[s].type = 'text') }
              for (s = i = 0; s < o; s++) {
 n[s].type === 'text' && s + 1 < o && n[s + 1].type === 'text'
 ...
 r === 124 &&
  ...
  function _e(e, r) {
    ...
    return (
      ...
      (s = e.eMarks[r]),
      ((t = e.src.charCodeAt(n++)) !== 42 && t !== 45 && t !== 43) ||
    ...
    (qe.prototype.getLines = function (e, r, t, n) {
      ...
      for (l = new Array(r - e), s = 0; p < r; p++, s++) {
        for (
          ...
          if (((i = this.src.charCodeAt(a)), Ee(i))) { i === 9 ? (o += 4 - ((o + this.bsCount[p]) % 4)) : o++ } else {
    ...
    Fe = [
      [
        ...
        function (e, r, t, n) {
          ...
          if ((v = e.src.charCodeAt(i++)) !== 124 && v !== 45 && v !== 58) { return !1 }
          if (i >= e.eMarks[l]) return !1
          if (
            (y = e.src.charCodeAt(i++)) !== 124 &&
            y !== 45 &&
            y !== 58 &&
            !pe(y)
          ) { return !1 }
          if (v === 45 && pe(y)) return !1
          for (; i < e.eMarks[l];) {
            if (
              (s = e.src.charCodeAt(i)) !== 124 &&
              s !== 45 &&
              s !== 58 &&
              !pe(s)
            ) { return !1 }
          ...
          for (
            ...
            if (!(d = u[a].trim())) {
              if (a === 0 || a === u.length - 1) continue
              return !1
            }
            if (!/^:?-+:?$/.test(d)) return !1
            d.charCodeAt(d.length - 1) === 58
              ? f.push(d.charCodeAt(0) === 58 ? 'center' : 'right')
              : d.charCodeAt(0) === 58
              ? f.push('left')
              : f.push('')
          }
          if ((o = he(e, r).trim()).indexOf('|') === -1) return !1
          if (e.sCount[r] - e.blkIndent >= 4) return !1
          if (
            ((u = fe(o)).length && u[0] === '' && u.shift(),
            u.length && u[u.length - 1] === '' && u.pop(),
            (p = u.length) === 0 || p !== f.length)
          ) { return !1 }
          if (n) return !0
          for (
            _ = e.parentType,
 ...
 if (e.isEmpty(n)) n++
      ...
      [
        ...
        function (e, r, t, n) {
          ...
          if (e.sCount[r] - e.blkIndent >= 4) return !1
          if (h + 3 > f) return !1
          if ((s = e.src.charCodeAt(h)) !== 126 && s !== 96) return !1
      ...
      [
        ...
        function (e, r, t, n) {
          var s,
            ...
            D = e.eMarks[r]
          if (e.sCount[r] - e.blkIndent >= 4) return !1
          if (e.src.charCodeAt(w) !== 62) return !1
          if (n) return !0
          for (
            f = [],
              d = [],
            ...
            !((w = e.bMarks[p] + e.tShift[p]) >= (D = e.eMarks[p])));
            p++
          ) {
 if (e.src.charCodeAt(w++) !== 62 || A) {
              if (l) break
 ...
 (e.bMarks[i + r] = f[i]),
      ...
      [
        ...
        function (e, r, t, n) {
          var s,
            ...
            l = e.eMarks[r]
          if (e.sCount[r] - e.blkIndent >= 4) return !1
          if ((s = e.src.charCodeAt(c++)) !== 42 && s !== 45 && s !== 95) { return !1 }
          for (o = 1; c < l;) {
      ...
      [
        ...
        function (e, r, t, n) {
          ...
          if (n) return !0
          for (
            m = e.src.charCodeAt(w - 1),
              d = e.tokens.length,
              u
                ? ((F = e.push('ordered_list_open', 'ol', 1)),
                  g !== 1 && (F.attrs = [['start', g]]))
                : (F = e.push('bullet_list_open', 'ul', 1)),
              F.map = f = [L, 0],
              F.markup = String.fromCharCode(m),
              D = !1,
            ...
            for (
              x = w,
                _ = e.eMarks[L],
                l = k = e.sCount[L] + w - (e.bMarks[L] + e.tShift[L]);
              x < _;

            ) {
              if ((s = e.src.charCodeAt(x)) === 9) { k += 4 - ((k + e.bsCount[L]) % 4) } else {
                if (s !== 32) break
                k++
              }
              x++
            ...
            if (
              ((c = (o = x) >= _ ? 1 : k - l) > 4 && (c = 1),
              (a = l + c),
              ((F = e.push('list_item_open', 'li', 1)).markup =
                String.fromCharCode(m)),
              (F.map = p = [L, 0]),
              u && (F.info = e.src.slice(E, w - 1)),
              (A = e.tight),
              (C = e.tShift[L]),
              (y = e.sCount[L]),
              (b = e.listIndent),
              ...
              (e.blkIndent = a),
              (e.tight = !0),
              (e.tShift[L] = o - e.bMarks[L]),
              (e.sCount[L] = k),
              o >= _ && e.isEmpty(L + 1)
                ? (e.line = Math.min(e.line + 2, t))
                : e.md.block.tokenize(e, L, t, !0),
              (e.tight && !D) || (T = !1),
              (D = e.line - L > 1 && e.isEmpty(e.line - 1)),
              (e.blkIndent = e.listIndent),
              (e.listIndent = b),
              (e.tShift[L] = C),
              (e.sCount[L] = y),
              (e.tight = A),
              ((F = e.push('list_item_close', 'li', -1)).markup =
                String.fromCharCode(m)),
              (L = e.line),
              (p[1] = L),
              L >= t)
 ...
 e.tokens[t].level === s &&
                    e.tokens[t].type === 'paragraph_open' &&
      ...
      [
        ...
        function (e, r, t, n) {
          var s,
            ...
            A = r + 1
          if (e.sCount[r] - e.blkIndent >= 4) return !1
          if (e.src.charCodeAt(y) !== 91) return !1
          for (; ++y < C;) {
 if (e.src.charCodeAt(y) === 93 && e.src.charCodeAt(y - 1) !== 92) {
              if (y + 1 === C) return !1
              if (e.src.charCodeAt(y + 1) !== 58) return !1
              break
            }
}
          for (
 ...
 if (k[l](e, A, a, !0)) {
          ...
          for (
            C = (g = e.getLines(r, A, e.blkIndent, !1).trim()).length, y = 1;
            y < C;
            y++
          ) {
            if ((s = g.charCodeAt(y)) === 91) return !1
            if (s === 93) {
              h = y
              break
            }
            (s === 10 || (s === 92 && ++y < C && g.charCodeAt(y) === 10)) &&
              v++
          }
          if (h < 0 || g.charCodeAt(h + 1) !== 58) return !1
          for (y = h + 2; y < C; y++) {
 if ((s = g.charCodeAt(y)) === 10) v++
            else if (!ve(s)) break
}
 ...
 if ((s = g.charCodeAt(y)) === 10) v++
          ...
          for (
            d = e.md.helpers.parseLinkTitle(g, y, C),
              y < C && m !== y && d.ok
                ? ((b = d.str), (y = d.pos), (v += d.lines))
                : ((b = ''), (y = o), (v = i));
            y < C && ((s = g.charCodeAt(y)), ve(s));

          ) { y++ }
          if (y < C && g.charCodeAt(y) !== 10 && b) {
 for (
              b = '', y = o, v = i;
              y < C && ((s = g.charCodeAt(y)), ve(s));
      ...
      [
        ...
        function (e, r, t, n) {
          var s,
            ...
            l = e.eMarks[r]
          if (e.sCount[r] - e.blkIndent >= 4) return !1
          if ((s = e.src.charCodeAt(c)) !== 35 || c >= l) return !1
          for (o = 1, s = e.src.charCodeAt(++c); s === 35 && c < l && o <= 6;) { o++, (s = e.src.charCodeAt(++c)) }
          return (
            !(o > 6 || (c < l && !De(s))) &&
            (n ||
              ((l = e.skipSpacesBack(l, c)),
              (i = e.skipCharsBack(l, 35, c)) > c &&
                De(e.src.charCodeAt(i - 1)) &&
                (l = i),
              (e.line = r + 1),
 ...
 if (u[o](e, l, t, !0)) {
  ...
  (Le.prototype.tokenize = function (e, r, t) {
    for (
      ...
      c < t &&
      ((e.line = c = e.skipEmptyLines(c)), !(c >= t)) &&
 ...
 if ((n = i[s](e, c, t, !1))) {
      ...
      (e.tight = !l),
        ...
        (c = e.line) < t && e.isEmpty(c) && ((l = !0), c++, (e.line = c))
    }
  }),
 ...
 (s = r[t]).marker === 126 &&
    ...
    for (; a.length;) {
      for (
        n = (t = a.pop()) + 1;
        n < e.tokens.length && e.tokens[n].type === 's_close';
 ...
 ((n = r[t]).marker !== 95 && n.marker !== 42) ||
  ...
  var Ue = {
      tokenize: function (e, r) {
        ...
        if (r) return !1
        if (o !== 95 && o !== 42) return !1
        for (n = e.scanDelims(e.pos, o === 42), t = 0; t < n.length; t++) {
 ...
 if (
          ((n = e[r]),
          f.push(0),
          (e[p].marker === n.marker && h === n.token - 1) || (p = r),
          (h = n.token),
          (n.length = n.length || 0),
          n.close)
        ) {
          for (
            l.hasOwnProperty(n.marker) ||
              (l[n.marker] = [-1, -1, -1, -1, -1, -1]),
 ...
 if (
              (s = e[t]).marker === n.marker &&
              s.open &&
              s.end < 0 &&
              ((a = !1),
              (s.close || n.open) &&
                (s.length + n.length) % 3 == 0 &&
                ((s.length % 3 == 0 && n.length % 3 == 0) || (a = !0)),
              !a)
            ) {
              (c = t > 0 && !e[t - 1].open ? f[t - 1] + 1 : 0),
                (f[r] = r - t + c),
                (f[t] = c),
                (n.open = !1),
                (s.end = r),
          ...
          i !== -1 &&
            (l[n.marker][(n.open ? 3 : 0) + ((n.length || 0) % 3)] = i)
        }
}
    }
  }
 ...
 if (t >= 1 && e.pending.charCodeAt(t - 1) === 32) {
                for (s = t - 1; s >= 1 && e.pending.charCodeAt(s - 1) === 32;) { s-- }
 ...
 (e.pending = e.pending.slice(0, -1)),
      ...
      [
        ...
        function (e, r) {
          ...
          if (++a >= c) return !1
          if ((t = e.src.charCodeAt(a)) === 10) {
            for (
              r || e.push('hardbreak', 'br', 0), a++;
              a < c && ((t = e.src.charCodeAt(a)), Me(t));
          ...
          return (
            ...
            r ||
              ...
              t < 256 && Be[t] !== 0 ? (i.content = o) : (i.content = s),
              (i.markup = s),
              (i.info = 'escape')),
            (e.pos = a + 1),
            !0
      ...
      [
        ...
        function (e, r) {
          ...
          for (t = u, u++, n = e.posMax; u < n && e.src.charCodeAt(u) === 96;) { u++ }
          if (
            ((c = (s = e.src.slice(t, u)).length),
            e.backticksScanned && (e.backticks[c] || 0) <= t)
          ) { return r || (e.pending += s), (e.pos += c), !0 }
          for (a = u; (i = e.src.indexOf('`', a)) !== -1;) {
            for (a = i + 1; a < n && e.src.charCodeAt(a) === 96;) a++
            if ((l = a - i) === c) {
 return (
                r ||
      ...
      [
        ...
        function (e, r) {
          ...
          if ((a = o + 1) < f && e.src.charCodeAt(a) === 40) {
            for (
              m = !1, a++;
              a < f && ((n = e.src.charCodeAt(a)), Ze(n) || n === 10);
              a++
            );
            if (a >= f) return !1
            if (
 ...
 for (
            ...
            (a >= f || e.src.charCodeAt(a) !== 41) && (m = !0), a++
          }
          if (m) {
      ...
      [
        ...
        function (e, r) {
          var t,
            ...
            g = e.pos,
            _ = e.posMax
          if (e.src.charCodeAt(e.pos) !== 33) return !1
          if (e.src.charCodeAt(e.pos + 1) !== 91) return !1
          if (
            ((a = e.pos + 2),
            (i = e.md.helpers.parseLinkLabel(e, e.pos + 1, !1)) < 0)
          ) { return !1 }
          if ((c = i + 1) < _ && e.src.charCodeAt(c) === 40) {
            for (
              c++;
              c < _ && ((n = e.src.charCodeAt(c)), Ge(n) || n === 10);
              c++
            );
            if (c >= _) return !1
            for (
 ...
 for (
            ...
            if (c >= _ || e.src.charCodeAt(c) !== 41) return (e.pos = g), !1
            c++
          } else {
            if (void 0 === e.env.references) return !1
            if (
              (c < _ && e.src.charCodeAt(c) === 91
                ? ((d = c + 1),
      ...
      [
        ...
        function (e, r) {
          ...
          for (i = e.pos, a = e.posMax; ;) {
            if (++c >= a) return !1
            if ((o = e.src.charCodeAt(c)) === 60) return !1
            if (o === 62) break
          }
          return (
            (t = e.src.slice(i + 1, c)),
      ...
      [
        ...
        function (e, r) {
          ...
          return (
            !!e.md.options.html &&
            ((s = e.posMax),
            !(e.src.charCodeAt(a) !== 60 || a + 2 >= s) &&
              !(
                (t = e.src.charCodeAt(a + 1)) !== 33 &&
                t !== 63 &&
                t !== 47 &&
                !(function (e) {
                  var r = 32 | e
              ...
              (r ||
                (((o = e.push('html_inline', '', 0)).content = n[0]),
                (i = o.content),
 ...
 s[r].nesting < 0 && n--,
              (s[r].level = n),
              s[r].nesting > 0 && n++,
              s[r].type === 'text' && r + 1 < o && s[r + 1].type === 'text'
 ...
 if ((r = s[t](e, !1))) {
  ...
  function dr(e) {
    return fr(e) === '[object Function]'
  }
  function mr(e) {
    return e.replace(/[.?*+^$[\]\\(){}|-]/g, '\\$&')
  }
  var gr = { fuzzyLink: !0, fuzzyEmail: !0, fuzzyIP: !1 }
  var _r = {
      'http:': {
    ...
    (e.__compiled__ = {}),
      Object.keys(e.__schemas__).forEach(function (r) {
        ...
        if (t !== null) {
          ...
          if (((e.__compiled__[r] = n), fr(t) === '[object Object]')) {
 return (
              !(function (e) {
                return fr(e) === '[object RegExp]'
              })(t.validate)
                ? dr(t.validate)
  ...
  function Ar(e, r) {
    ...
    r ||
      ...
      (this.__opts__ = hr({}, gr, r)),
      (this.__index__ = -1),
      (this.__last_index__ = -1),
      (this.__schema__ = ''),
      (this.__text_cache__ = ''),
      (this.__schemas__ = hr({}, _r, e)),
      (this.__compiled__ = {}),
      (this.__tlds__ = br),
 ...
 if ((s = this.testSchemaAt(e, r[2], a.lastIndex))) {
    ...
    (Ar.prototype.match = function (e) {
      ...
      this.__index__ >= 0 &&
        ...
        (t.push(Cr(this, r)), (r = this.__last_index__))
 ...
 t.push(Cr(this, r)),
  ...
  /*! https://mths.be/punycode v1.4.1 by @mathias */ function jr(e) {
      ...
      for (
        ...
        s >= f && jr('invalid-input'),
          ((c =
            ...
            jr('overflow'),
          (d += c * i),
          !(c < (l = a <= g ? Er : a >= g + qr ? qr : a - g));
        a += Dr
      ) { i > Or(wr / (u = Dr - l)) && jr('overflow'), (i *= u) }
      (g = Hr(d - o, (r = h.length + 1), o == 0)),
        Or(d / r) > wr - m && jr('overflow'),
        (m += Or(d / r)),
        (d %= r),
        h.splice(d++, 0, m)
    }
 ...
 if (((p = e[i]) < r && ++t > wr && jr('overflow'), p == r)) {
          for (
            c = t, l = Dr;
            !(c < (u = l <= o ? Er : l >= o + qr ? qr : l - o));
            l += Dr
          ) {
 (m = c - u),
              (d = Dr - u),
              g.push(Pr(Gr(u + (m % d), 0))),
              (c = Or(m / d))
}
  ...
  function at(e) {
    var r = y.parse(e, !0)
    if (r.hostname && (!r.protocol || it.indexOf(r.protocol) >= 0)) {
 try {
 ...
 try {
  ...
  function lt(e, r) {
    ...
    r || D.isString(e) || ((r = e || {}), (e = 'default')),
      (this.inline = new ur()),
      (this.block = new ze()),
      (this.core = new ue()),
      (this.renderer = new B()),
      (this.linkify = new xr()),
      (this.validateLink = ot),
      (this.normalizeLink = at),
      (this.normalizeLinkText = ct),
      (this.utils = D),
      (this.helpers = D.assign({}, L)),
      (this.options = {}),
      this.configure(e),
      r && this.set(r)
  }
...
export const MarkdownIt = markdown()